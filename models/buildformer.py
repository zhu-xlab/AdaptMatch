...
class BuildFormer(nn.Module):
    ...
    #     x = x + dp
    #     x = self.head(x)
    #     x = F.interpolate(x, sz, mode='bilinear')
    #     return x
    ...
    def get_1x_lr_params_NOscale(self):
        b = []
        b.append(self.backbone.parameters())
        b.append(self.dp.parameters())
        b.append(self.fpn.parameters())
