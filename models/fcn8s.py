...
class FCN8s(nn.Module):
    def __init__(self, num_classes=21):
        ...
        self.trg_trnasfer_conv = nn.Sequential(
    ...
    def forward(self, x, lbl=None, weight=None, ita=1.5):
        ...
        if lbl is not None:
            ...
            self.loss_seg = self.CrossEntropy2d(h, lbl)         
    ...
    def CrossEntropy2d(self, predict, target, size_average=True):
        ...
        loss = F.cross_entropy(predict, target, size_average=size_average)
        return loss    
            
def VGG16_FCN8s(num_classes=21, restore_from=None):
